...
import { o as omit } from "./index-CmS0GGFw.js";
import { t as tv } from "./tv-DTu_ffsP.js";
import { p as pickLinkProps, _ as _sfc_main$1, a as _sfc_main$2 } from "./Link-DvjPaNEy.js";
import { _ as _sfc_main$3 } from "./Icon-D99OMy3A.js";
import { _ as _sfc_main$4 } from "./Avatar-BBvgSf-4.js";
        ...
        default: withCtx(({ active, ...slotProps }, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$2, mergeProps(slotProps, {
              class: ui.value.base({
                class: [(_a = props.ui) == null ? void 0 : _a.base, props.class],
                active,
                ...
                if (_push3) {
                  ssrRenderSlot(_ctx.$slots, "leading", {}, () => {
                    ...
                    if (unref(isLeading) && unref(leadingIconName)) {
                      _push3(ssrRenderComponent(_sfc_main$3, {
                        ...
                        class: ui.value.leadingIcon({ class: (_a2 = props.ui) == null ? void 0 : _a2.leadingIcon, active })
                  ...
                  ssrRenderSlot(_ctx.$slots, "default", {}, () => {
                    ...
                    if (__props.label !== void 0 && __props.label !== null) {
                      _push3(`<span class="${ssrRenderClass(ui.value.label({ class: (_a2 = props.ui) == null ? void 0 : _a2.label, active }))}"${_scopeId2}>${ssrInterpolate(__props.label)}</span>`);
                    } else {
                      _push3(`<!---->`);
                    }
                  }, _push3, _parent3, _scopeId2);
                  ssrRenderSlot(_ctx.$slots, "trailing", {}, () => {
                    ...
                    if (unref(isTrailing) && unref(trailingIconName)) {
                      _push3(ssrRenderComponent(_sfc_main$3, {
                        ...
                        class: ui.value.trailingIcon({ class: (_a2 = props.ui) == null ? void 0 : _a2.trailingIcon, active })
                      }, null, _parent3, _scopeId2));
                    } else {
                      _push3(`<!---->`);
                    }
                    ...
                    renderSlot(_ctx.$slots, "default", {}, () => {
                      ...
                      return [
                        __props.label !== void 0 && __props.label !== null ? (openBlock(), createBlock("span", {
                          key: 0,
                          class: ui.value.label({ class: (_a2 = props.ui) == null ? void 0 : _a2.label, active })
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@3.1.3_@babel+parser@7.27.5_db0@0.3.2_better-sqlite3@11.10.0__embla-carousel@8.6.0_io_c3rkd63amtmtd64x55vod7vajy/node_modules/@nuxt/ui/dist/runtime/components/Button.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as _
};
//# sourceMappingURL=Button-jux90PMD.js.map
